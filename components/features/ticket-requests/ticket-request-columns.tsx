...
export const createTicketRequestColumns = (): ColumnDef<TicketRequestItem>[] => [
  {
    accessorKey: "ticket.name",
    header: () => <span className="text-secondary-100">Ticket</span>,
    cell: ({ row }) => {
      const request = row.original;
      return (
        <div className="space-y-1">
          <div className="font-medium">{request.ticket.name}</div>
