...
// Account self-service schema: same as UpdateOrganizationSchema but
// excludes organizationParentId (users cannot change their own org parent).
...
export type AccountOrganizationSchema = z.infer<typeof AccountOrganizationSchema>;